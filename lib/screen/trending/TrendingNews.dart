...
class _TrendingNewsstate extends State<TrendingNews> {
  ...
  Future<void> _loadMoreVideos() async {
    ...
    try {
      List<Video> newVideos = await youtubeDataApi.fetchTrendingNews();
      setState(() {
...
class YoutubeDataApi {
  ...
  Future<List<Video>> fetchTrendingNews() async {
    String url = '$baseUrl/videos?part=snippet&chart=mostPopular&maxResults=10&regionCode=US&videoCategoryId=25&key=$apiKey';
