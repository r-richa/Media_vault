...
class _TrendingAllstate extends State<TrendingAll> {
  ...
  Future<void> _loadMoreVideos() async {
    ...
    try {
      List<Video> newVideos = await youtubeDataApi.fetchTrendingAll();
      setState(() {
...
class YoutubeDataApi {
  ...
  Future<List<Video>> fetchTrendingAll() async {
    String url = '$baseUrl/videos?part=snippet&chart=mostPopular&maxResults=10&regionCode=US&key=$apiKey';
